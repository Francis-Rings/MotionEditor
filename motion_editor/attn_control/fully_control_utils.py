...
def regiter_fully_attention_editor_diffusers(model, editor: MutualAttentionBase):
    """
    ...
    def register_editor(net_, count, place_in_unet):
        if net_.__class__.__name__ == 'MotionFrameAttention' or net_.__class__.__name__ == 'CrossAttention':
